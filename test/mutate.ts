...
const steeringMutations: Mutation[] = [
	...
	{
		name: "an entry may be shipped without a confirmed measurement",
		from: "export const MODEL_STEERING: readonly ModelSteering[] = Object.freeze([]);",
		to: "export const MODEL_STEERING: readonly ModelSteering[] = Object.freeze([Object.freeze({ pattern: /gpt/i, stage2: [\"x\"] })]);",
		expect: "empty until an entry is confirmed out of sample",
	},
	{
		name: "a shipped entry reaches a model that was never measured",
		from: "export const MODEL_STEERING: readonly ModelSteering[] = Object.freeze([]);",
		to: "export const MODEL_STEERING: readonly ModelSteering[] = Object.freeze([Object.freeze({ pattern: /claude/i, stage2: [\"x\"] })]);",
		expect: "no model receives steering while the table is empty",
	},
	{
